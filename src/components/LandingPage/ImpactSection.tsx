    ...
    <section className={`w-full py-12 md:py-24 lg:py-32 ${isDarkMode ? 'bg-gray-800' : 'bg-white'}`}>
      <div className="px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          <div>
            <p className="text-4xl font-bold text-primary">{counters.students}+</p>
            <p className="text-xl">Students Enrolled</p>
          </div>
          <div>
            <p className="text-4xl font-bold text-primary">{counters.teachers}+</p>
            <p className="text-xl">Expert Teachers</p>
          </div>
          <div>
            <p className="text-4xl font-bold text-primary">{counters.courses}+</p>
