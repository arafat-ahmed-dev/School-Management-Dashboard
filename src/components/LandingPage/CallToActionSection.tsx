...
const CallToActionSection = ({ isDarkMode, loading }: { isDarkMode: boolean; loading: boolean }) => {
  return (
    <section
    ...
    >
      <div className="px-4 md:px-6">
        {loading ? ( // Conditional rendering for skeleton
          <div className={`skeleton-call-to-action ${isDarkMode ? "bg-gray-700" : "bg-gray-300"}`}>
